  ...
  describe('initialization', () => {
    ...
    it('throws error for missing bot token', async () => {
      ...
      await expect(trigger.initialize({
        ...
        clientId: '123456789',
        channelIds: ['987654321'],
      } as unknown as TriggerConfig)).rejects.toThrow('Discord trigger requires botToken')
    })
    ...
    it('throws error for missing client ID', async () => {
      ...
      await expect(trigger.initialize({
        ...
        botToken: 'test-bot-token',
        channelIds: ['987654321'],
      } as unknown as TriggerConfig)).rejects.toThrow('Discord trigger requires clientId')
    })
    ...
    it('throws error for missing channel IDs', async () => {
      ...
      await expect(trigger.initialize({
        ...
        botToken: 'test-bot-token',
        clientId: '123456789',
      } as unknown as TriggerConfig)).rejects.toThrow('Discord trigger requires at least one channelId')
    })
  })
