...
For the full repository layout — including non-published directories (`pipelines/internal`, `examples`, `scripts/guards`, `tests`, `docs`) — see the **Repo shape** section of [`AGENTS.md`](../../AGENTS.md).
