...
The gateway hosts an embedded CONNECT proxy (default port `server.port + 1` = 14739) that enforces `networkEgress` permissions. See the [Gateway guide](../../../docs/guides/gateway.md#network-egress-proxy) for details.
